        ...
        <div class="row">
            <div class="col-md-12 header-footer">
                <span>
                    ...
                    Bạn cần xuất trình giấy tờ tùy thân hợp lệ nếu được yêu cầu (tuân theo quy định pháp luật địa phương). 
                    Các đối tác của Silk Road có quyền từ chối, hủy bỏ, hoặc giới hạn số lượng mua hàng vì bất kỳ lý do gì.
                    Vui lòng tham khảo thêm thông tin chi tiết tại Điều khoản & Điều kiện hoặc liên hệ với dịch vụ khách hàng của Silk Road.
                </span>
            </div>
            <div style="width: 100%;" class="col-md-12">
                <div class="content-footer"
                    ...
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="width: 24px; height: 24px; vertical-align: middle; margin-right: 5px;">
